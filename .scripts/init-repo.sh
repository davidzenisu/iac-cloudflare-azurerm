...
AZURE_TENANT_ID_KEY=ARM_TENANT_ID
AZURE_SUBCRIPTION_ID_KEY=ARM_SUBSCRIPTION_ID
AZURE_CLIENT_ID_KEY=ARM_CLIENT_ID
AZURE_BACKEND_RG_KEY=ARM_BACKEND_RG
AZURE_BACKEND_ST_KEY=ARM_BACKEND_ST
